...
/**
 * This class is for customized time picker that change minute interval based on input variable
 * increment.
...
public class DurationTimePickDialog extends TimePickerDialog
{
    ...
    public DurationTimePickDialog(Context context, OnTimeSetListener callBack, int hourOfDay,
                                  int minute, boolean is24HourView, int increment) {
